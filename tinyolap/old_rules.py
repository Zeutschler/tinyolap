...
#
#     def on_set(self, super_level, idx_address, measure, value):
...
#                 if self.formulas[formula_idx]["type"] != Rules.RulesScope.PUSH_DOWN:
...
#                     else:
#                         variables.append(self.cube.get(idx_address, trigger))
#
...
#                 self.cube.set(idx_address, self.formulas[formula_idx]["target"], result)
#         return True
#
#     def on_get(self, super_level, idx_address, measure):
...
#         if (super_level == 0) and (formula_type == Rules.RulesScope.AGGREGATION):
...
#         message = ""
#         comment = ""
#         formula_type = Rules.RulesScope.UNIVERSAL
#         name = None
#         code = None
#         triggers = []
#         target = None
...
#             formula_type = Rules.RulesScope.PUSH_DOWN
#         elif formula.lower().startswith("a:"):
#             formula_type = Rules.RulesScope.AGGREGATION
#
